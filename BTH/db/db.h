...
#define BACKGROUND_COLOR_DEFAULT				"('BACKGROUND_COLOR', 0.02, 0.00, 0.18, 1.00)"
...
#define DISASSEMBLY_BACKGROUND_COLOR_DEFAULT	"('DISASSEMBLY_BACKGROUND_COLOR', 0.00, 0.00, 0.00, 1.00)"
...
#define INTERPRETER_BACKGROUND_COLOR_DEFAULT	"('INTERPRETER_BACKGROUND_COLOR', 0.00, 0.00, 0.00, 1.00)"
#define INTERPRETER_TEXT_COLOR_DEFAULT			"('INTERPRETER_TEXT_COLOR', 0.76, 0.76, 0.90, 1.00)"
...
static const std::vector<std::string> COLORSETTINGS_INITVEC = {
	...
	// DISASSEMBLY VISUALS
	DISASSEMBLY_BACKGROUND_COLOR_DEFAULT,
	...
	// INTERPRETER VISUALS
	INTERPRETER_BACKGROUND_COLOR_DEFAULT,
	INTERPRETER_TEXT_COLOR_DEFAULT,
